...
class AttendanceController extends Controller
{
    public function create(){
        ...
        $rest = DB::table("rests")->whereDate("date",Carbon::now()->format("Y-m-d"))->orderBy("stamp_id","asc")->Paginate(5);
        $rest_at = Rest::whereDate("date",Carbon::now()->format("Y-m-d"))->orderby("user_id","asc");
